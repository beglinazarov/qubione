...
namespace Catalog.API.Infrastructure
{
	public class CatalogContextSeed
	{
		...
		private IEnumerable<CatalogBrand> GetPreconfiguredCatalogBrands()
		{
			...
			{
				new CatalogBrand() { Brand = "Zara"},
				new CatalogBrand() { Brand = "Bershka" },
				new CatalogBrand() { Brand = "Marka Milano" },
				new CatalogBrand() { Brand = "H&M" },
		...
		private IEnumerable<CatalogType> GetPreconfiguredCatalogTypes()
		{
			...
			{
				new CatalogType() { Type = "Short"},
				new CatalogType() { Type = "T-Shirt" },
				new CatalogType() { Type = "Jeans" },
				new CatalogType() { Type = "Hoodie" }
			};
		}
